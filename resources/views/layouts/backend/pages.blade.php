...
<li>
    ...
    <ul class="sub-menu" aria-expanded="false">
        <li><a href="" key="t-full-calendar">View</a></li>
    </ul>
</li>
<li>
    <a href="javascript: void(0);" class="has-arrow waves-effect">
    ...
    <ul class="sub-menu" aria-expanded="false">
        <li><a href="" key="t-tui-calendar">All Partners</a></li>
    </ul>
</li>
<li>
  <a href="javascript: void(0);" class="has-arrow waves-effect">
  ...
  <ul class="sub-menu" aria-expanded="false">
      <li><a href="" key="t-tui-calendar">All Blogs</a></li>
      <li><a href="" key="t-full-calendar">Create Blog</a></li>
  </ul>
</li>
{{-- <li>
    <a href="javascript: void(0);" class="has-arrow waves-effect">
        <img src="" class="property_icon" alt="">
        <span key="t-dashboards">User</span>
    </a>
    <ul class="sub-menu" aria-expanded="false">
        <li><a href="" key="t-tui-calendar">All User</a></li>
        <li><a href="" key="t-full-calendar">Add User</a></li>
    </ul>
</li> --}}
{{-- <li>
  <a href="javascript: void(0);" class="has-arrow waves-effect">
